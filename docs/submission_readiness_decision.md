...
Honest strongest claim: `Separate human intent from morphology-specific motion artifacts in video demonstrations.` is a plausible branch-structured mechanism for learning robots from human video, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
